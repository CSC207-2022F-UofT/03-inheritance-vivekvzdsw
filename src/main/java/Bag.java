...
public abstract class Bag {
    ...
    public boolean addItem(String item) {
        if (this.numberOfContents < this.capacity) {
            String[] contentt = new String[this.numberOfContents + 1];
            for (int i = 0; i < this.numberOfContents; i++) {
                contentt[i] = this.contents[i];
            }
            contentt[this.numberOfContents] = item;
            this.contents = contentt;
    ...
    public String popItem() {
        ...
        String prev = this.contents[this.numberOfContents-1];
        this.contents = contentt;
        this.numberOfContents--;
